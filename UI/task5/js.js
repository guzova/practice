...
var domManagement = (function () {
    ...
    function makeHTML(article) {
        ...
        copy.querySelector('.dateCreated').innerText = article.createdAt.toString();
        copy.querySelector('.authorr').innerText = article.author;
        return copy;
    }
...
function authorize(author) {
    ...
    if (button) {
        document.querySelector('.dropdown-inside').style.display = 'block'
...
function deAuthorize() {
    var button = document.getElementById('authorize');
    if (button) {
        document.querySelector('.dropdown-inside').style.display = 'none'
